  ...
  return(
      ...
      <View style={styles.headerRow}>
        ...
        <View style={styles.fechaRow}>
          <MaterialCommunityIcons name="calendar-outline" size={14} color="#888" />
      ...
      <View style={styles.card}>
        <View style={styles.titulo}>
          <MaterialCommunityIcons name="account-outline" size={22} color="#356668" />
      ...
      <View style={styles.card}>
        <View style={styles.titulo}>
          <MaterialCommunityIcons name="list-status" size={22} color="#356668" />
        ...
        <View style={styles.chipRow}>
          {ESTADOS.map((e) => (
            <TouchableOpacity
              ...
              style={[
                styles.chip,
                form.estado === e && { backgroundColor: COLOR_ESTADO[e], borderColor: COLOR_ESTADO[e] },
              ]}
            >
              <Text style={[
                styles.chipTexto,
      ...
      <View style={styles.card}>
        <View style={styles.titulo}>
          <MaterialCommunityIcons name="flag-outline" size={22} color="#356668" />
        ...
        <View style={styles.chipRow}>
          {PRIORIDADES.map((p) => (
            <TouchableOpacity
              key={p}
              onPress={() => setForm(prev => ({ ...prev, prioridad: p }))}
              style={[
                styles.chip,
      ...
      <View style={styles.card}>
        <View style={styles.titulo}>
          <MaterialCommunityIcons name="text-box-outline" size={22} color="#356668" />
...
const styles = StyleSheet.create({
  contenedor:       { flex: 1, backgroundColor: "#F7F9FE", padding: 20 },

  headerRow:        { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 14 },
  idBox:            { borderWidth: 1.5, borderColor: "#98ccd1", borderRadius: 10, paddingHorizontal: 16, paddingVertical: 10, backgroundColor: "#E8F3F4" },
  idTexto:          { fontSize: 20, fontWeight: "bold", color: "#356668" },
  fechaRow:         { flexDirection: "row", alignItems: "center", gap: 5 },
  fechaTexto:       { fontSize: 12, color: "#888" },

  card:             { backgroundColor: "#fff", borderRadius: 15, borderColor: "#E6E8E9", borderWidth: 2, padding: 15, marginBottom: 14 },
  titulo:           { flexDirection: "row", gap: 8, alignItems: "center", marginBottom: 12 },
  cardTitle:        { fontSize: 15, fontWeight: "bold", color: "#356668", letterSpacing: 0.5 },
  minilabel:        { fontSize: 11, color: "#6B7280", fontWeight: "500", marginBottom: 4 },
  valorTexto:       { fontSize: 14, color: "#222", fontWeight: "500" },
  filaInfo:         { flexDirection: "row", justifyContent: "space-between", marginBottom: 14 },
  telefonoRow:      { flexDirection: "row", alignItems: "center", gap: 6 },
  ...
  punto:            { width: 7, height: 7, borderRadius: 10 },

  input:            { backgroundColor: "#ddeef0", padding: 14, borderRadius: 12, minHeight: 110, textAlignVertical: "top", fontSize: 14, color: "#333" },

  btnGuardar:       { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#356668", borderRadius: 12, padding: 15, marginBottom: 10 },
  btnGuardarTexto:  { color: "#fff", fontWeight: "bold", fontSize: 15 },
  btnEliminar:      { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#fff", borderRadius: 12, padding: 15, borderWidth: 1.5, borderColor: "#f09595" },
  btnEliminarTexto: { color: "#a32d2d", fontWeight: "bold", fontSize: 15 },
});